// Part that surrounds DEC1 body next to the counterweight cap,
// covers the polar scope port and has helmet supports.
// Author: James Synge
...
dec1_hat_and_helmet_support();

*dec1_hat_and_helmet_support(over_port=true, remainder=false, sleeve=false);
*dec1_hat_and_helmet_support(over_port=false, remainder=true, sleeve=false);
*dec1_hat_and_helmet_support(over_port=false, remainder=false, sleeve=true);



module dec1_hat_and_helmet_support(over_port=true, remainder=true, sleeve=true) {
  difference() {
    intersection() {
      dec1_hat_extrusion_in_position(
...
module cw_chin_strap_helmet_support_profile() {
  intersection() {
    annulus(r1=ra1_radius, r2=dflt_helmet_ir);
    dec_trim_strap_dec_axis_extent();
  }
}

module cw_chin_strap_trim_axis_extent() {
